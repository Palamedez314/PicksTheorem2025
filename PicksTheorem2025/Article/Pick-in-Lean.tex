...
\author{Elli zu Neblberg \& friends} % collaborators} % 
...
\begin{figure}[ht]
  \begin{tikzpicture}[x=5mm, y=5mm, rounded corners=0.1pt]
    \begin{scope}[shift={(-5,-2)}]
      ...
      \draw[line width=1pt, blue, fill=yellow!50, fill opacity=0.3] (0,0) rectangle (6,4);
...
Using this, we swap the double sum defining the right hand side:
\begin{alignat}{3}
  & \Welp(P)
...
\begin{remark}
  ...
  (3) The extension to boundary points is usually neglected. % omitted.
